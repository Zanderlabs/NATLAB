...
% Enables processing of raw prediction, like distance from hyperplane as implemented for LDA in ml_predictlda    
elseif strcmp(opts.out_form,'rawScore')
  opts.channel_names = { 'RawScore' };
else
    if isfield(model,'classes') && ~isempty(model.classes)
