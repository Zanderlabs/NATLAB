...
opts = arg_define([0 2],varargin, ...
    ...
    arg({'format','OutputFormat'},'distribution',{'distribution','expectation','mode','rawScore'},'Output format. The format in which each individual prediction is represented -- can be a discrete/continuous probability distribution, the most likely value (mode), or the expected value (expectation).'), ...
